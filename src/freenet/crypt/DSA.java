...
public class DSA {
	...
	static DSASignature sign(DSAGroup g, DSAPrivateKey x,
		...
		if((r.compareTo(BigInteger.ZERO) == 0) || (s.compareTo(BigInteger.ZERO) == 0)) {
			Logger.notice(DSA.class, "DSA : R or S equals 0 : Weird behaviour detected, please report if seen too often.");
	...
	public static boolean verify(DSAPublicKey kp,
		...
		try {
			...
			Logger.notice(DSA.class, "DSA : Verify failed: "+e.toString());
			e.printStackTrace();
